...
from .models import Airline, Airport, Flight, FlightStatus, FlightTracking
...
class FlightAdmin(admin.ModelAdmin):
    ...
    def get_departure_time(self, obj):
        return (
            obj.estimated_departure_time.strftime("%Y-%m-%d %H:%M:%S")
    ...
    def get_arrival_time(self, obj):
        return (
            obj.estimated_arrival_time.strftime("%Y-%m-%d %H:%M:%S")
...
class FlightStatusAdmin(admin.ModelAdmin):
    ...
    )  # Use 'flight__airline__name' for filtering by airline's name
...
class FlightTrackingAdmin(admin.ModelAdmin):
    list_display = (
        "aircraft_id",
        "registration",
        "flight",
    ...
    search_fields = ("flight", "callsign", "registration")
    list_filter = ("onground", "origin", "destination")
...
admin.site.register(FlightTracking, FlightTrackingAdmin)
